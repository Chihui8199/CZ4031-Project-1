...
public class Parser {
     ...
     */
    // TODO: change this to Buffered Reader implementation I couldn't figure out the
    // conversin
    ...
    public static void readTSVFile(String filePath) {
        ...
        tree.insertKey(35000, addr5);
        tree.insertKey(36000, addr5);
        tree.insertKey(37000, addr2);
        tree.insertKey(38000, addr2);
        tree.insertKey(39000, addr2);
...
//        tree.printBPlusTree(testBplusTree.getRoot());
        ...
        // // TODO: parse each of the three fields to byteArray so that each Record can
        // be initialise as a fixed length
